...
Promise
  .all([readCss, readJs, readManifest])
  .then(([cssFiles, jsFiles, manifestFile]) => {
    ...
    // Load the index.html
    fs
      .readFileAsync('src/client/assets/index.html', 'utf8')
      .then((markup) => {
      ...
      <script>
        ...
        fs.writeFileAsync('build/client/index.html', $.html(), 'utf8').catch(console.error)
