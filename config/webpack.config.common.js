// Common Webpack configuration used by webpack.config.development and
...
const babelLoaderQuery = {
  ...
  plugins: ['babel-plugin-transform-decorators-legacy', 'babel-plugin-lodash', 'react-hot-loader/babel'].map(require.resolve)
}
...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      // Images Any images inside FileList/filetype should use urls Small images in
      // other folders will be inlined.
      {
        test: /\.(png|jpg|jpeg|gif|svg)$/,
        include: [path.resolve(__dirname, '../node_modules/stemn-frontend-shared/src/misc/FileList/filetype')],
        loader: 'url',
        query: {
          limit: 1,
        ...
        exclude: [path.resolve(__dirname, '../node_modules/stemn-frontend-shared/src/misc/FileList/filetype')],
        loader: 'url',
        query: {
          limit: 8192,
          name: 'images/[name].[ext]?[hash]'
